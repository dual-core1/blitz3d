...
mesh(0),n_verts(0),n_tris(0),n_frames(0){
	...
	// dual-core: changed '.begin()' to '[0]', used address-of operator
...
void MD2Rep::render( Model *model,int render_a,int render_b,float render_t ){
	...
	// dual-core: changed '.begin()' to '[0]'
	// also, used address-of operator, we are working with pointers here after all
